...
char string2[BUFFER_SIZE]; //initializing an array of characters which is 80 bytes long
do{
    ...
    if ((strcmp(string1, "q")) == 0) { //if the user types in "q" then the program will quit
...
}while(strcmp(string1, "q")); //as long as the user does not type in "q"
